...
public class MybatisjjInterceptor extends EntityProvider implements Interceptor {

	private BeforeSaveEntityInterceptor beforeSaveEntityInterceptor;

	public MybatisjjInterceptor(BeforeSaveEntityInterceptor beforeSaveEntityInterceptor) {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		// 插入前或更新前的逻辑
		if (parameter != null && beforeSaveEntityInterceptor != null) {
			// insert
		...
		if ((generatedKeyResult != null) && (generatedKeyResult instanceof TableIdEntity)) {
			TableIdEntity tableIdEntity = (TableIdEntity) generatedKeyResult;
			
			if (SqlCommandType.INSERT.equals(commandType) && tableIdEntity!=null && IdTypeConstant.AUTO.equals(tableIdEntity.getIdType())) {
				// 判断影响的行数
